...
class ColumnChartGeneralTabBar extends StatelessWidget {
  ColumnChartGeneralTabBar({Key? key}) : super(key: key);
  ...
  final List<ColumnChartModel> dayData = [
    ColumnChartModel(
        ...
        color: charts.ColorUtil.fromDartColor(
            const Color.fromARGB(255, 35, 111, 87))),
    ColumnChartModel(
        time: '28/2',
        money: 500,
        color: charts.ColorUtil.fromDartColor(
  ...
  Widget build(BuildContext context) {
    final List<charts.Series<ColumnChartModel, String>> daySeries = [
      charts.Series(
        id: 'money',
        data: dayData,
    ...
    final List<charts.Series<ColumnChartModel, String>> monthSeries = [
      charts.Series(
        id: 'money',
        data: monthData,
    ...
    final List<charts.Series<ColumnChartModel, String>> yearSeries = [
      charts.Series(
        id: 'money',
        data: yearData,
